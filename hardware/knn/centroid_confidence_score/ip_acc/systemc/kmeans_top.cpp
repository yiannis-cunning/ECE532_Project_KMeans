...
kmeans_top::kmeans_top(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    grp_classify_image_fu_45->image_r_address1(grp_classify_image_fu_45_image_r_address1);
    grp_classify_image_fu_45->image_r_ce1(grp_classify_image_fu_45_image_r_ce1);
    grp_classify_image_fu_45->image_r_q1(image_r_q1);
    ...
    sensitive << ( grp_classify_image_fu_45_image_r_address1 );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    sensitive << ( grp_classify_image_fu_45_image_r_ce1 );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    sc_trace(mVcdFile, grp_classify_image_fu_45_image_r_address1, "grp_classify_image_fu_45_image_r_address1");
    sc_trace(mVcdFile, grp_classify_image_fu_45_image_r_ce1, "grp_classify_image_fu_45_image_r_ce1");
...
void kmeans_top::thread_image_r_address1() {
    image_r_address1 = grp_classify_image_fu_45_image_r_address1.read();
}
...
void kmeans_top::thread_image_r_ce1() {
    image_r_ce1 = grp_classify_image_fu_45_image_r_ce1.read();
}
